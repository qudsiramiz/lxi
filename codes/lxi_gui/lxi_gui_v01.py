...
def plot_data(file_name_sci=None, file_name_hk=None, t_start=None, t_end=None):
    ...
    img1_ts.grid(row=2, column=0, rowspan=1, columnspan=2, sticky="w")
    ...
    img2_ts.grid(row=4, column=0, rowspan=1, columnspan=2, sticky="w")
    ...
    img3_ts.grid(row=6, column=0, rowspan=1, columnspan=2, sticky="w")
    ...
    img2.image = render2
    img2.grid(row=2, column=4, rowspan=3, columnspan=3, sticky="n")
    ...
    # Resize the image to fit the canvas (in pixels)
    load3 = load3.resize((int(fig3.get_figwidth() * 60),
                          int(fig3.get_figheight() * 60)))
    render3 = ImageTk.PhotoImage(load3)
    img3 = tk.Label(image=render3)
    img3.image = render3
    img3.grid(row=5, column=4, rowspan=2, columnspan=2, sticky="n")
    ...
    # Resize the image to fit the canvas (in pixels)
    load4 = load4.resize((int(fig4.get_figwidth() * 60),
                          int(fig4.get_figheight() * 60)))
    render4 = ImageTk.PhotoImage(load4)
    img4 = tk.Label(image=render4)
    img4.image = render4
    img4.grid(row=5, column=6, rowspan=2, columnspan=2, sticky="n")
...
plot_opt_label_2.grid(row=2, column=0, columnspan=2, pady=0, sticky="w")
...
ts_menu_2.grid(row=3, column=1, columnspan=1, sticky="w")

plot_opt_label_3 = tk.Label(root, text="Plot options:", font=font_style_box)
plot_opt_label_3.grid(row=4, column=0, columnspan=1, pady=0, sticky="w")
...
ts_menu_3.grid(row=5, column=1, columnspan=1, sticky="w")
...
start_time.grid(row=8, column=3, columnspan=1, pady=5, ipadx=10, ipady=10)
start_time_label = tk.Label(root, text="Start Time", font=font_style)
start_time_label.grid(row=9, column=3, columnspan=1)
