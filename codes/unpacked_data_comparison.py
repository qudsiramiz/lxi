...
if read_data:
    df_sc_n = pd.read_csv(
        "../data/raw_data/2022_04_29_0900_LEXI_HK_unit1_mcp_unit1_eBox_1800V_hk_/2022_04_29_0900_LEXI_Sci_unit1_mcp_unit1_eBox_1800V.csv")
    df_sc_q = pd.read_csv(
        "../data/processed_data/sci/2022_04_29_0900_LEXI_rawunit1_mcp_unit1_eBox_1800V_sci_output.csv")
    ...
    #               '+5.2V_Imon', '+10V_Imon', '+3.3V_Imon', '+28V_Imon', 'ADC_Ground',
    # 'Cmd_count','Pinpuller_Armed', 'Unused', 'Unused', 'HVmcpAuto', 'HVmcpMan', 'DeltaEvntCount',
